...
function setup() {
  ...
  ground = createSprite(width,height/2-10,width,20);
  ground.addImage("ground",groundImage);
  ground.x = width /2;
  ground.velocityX = -(6 + 3*score/100);
  
  ground1 = createSprite(width-1000,height/2-10,width,20);
...
function draw() {
  //trex.debug = true;
  background(255);
  text("Pontuação: "+ score, width-200, 150);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width,height/2-30,10,40);
    //obstacle.debug = true;
